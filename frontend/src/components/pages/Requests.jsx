        ...
        <div className="space-y-2 w-full">
          {reqLoading?(
            ...
            data?.incommingReq.length<1?(
              <div className="p-2 bg-gradient-to-bl from-primary to-secondary rounded-md flex items-center justify-center flex-col space-y-3">
                <h2 className="text-xl md:text-3xl font-bold mt-5 text-white">No Friend requests.</h2>
                <p className="text-xs md:text-sm text-center text-white">You have no incoming friend requests.</p>
                <button className="px-3 py-2 mb-5 h-10 transition-all text-white hover:scale-105 duration-300  border-white border-2 hover:border-primary hover:bg-gradient-to-tr from-primary/70 to-secondary/70 text-sm font-bold rounded-md">Explore Friends</button>
              </div>
            ):(<></>)
          )}
